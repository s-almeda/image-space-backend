...
async function initDB() {
  ...
  // Create users table - updating column names to match API expectations
  await db.exec(`
  ...
  // Create user_images table - updating to match API expectations
  await db.exec(`
  ...
  // Create pinned_artworks table - updating to match API expectations
  await db.exec(`
